...
const Data=()=>{
  return (
    <div className='home_data'>
      <h1 className="home_tittle">Sandip Panda
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <h3 className="home_subtittle">
        FullStack Web Devloper
      </h3>
      <p className="home_description">
        I'm craetive Devloper based in India, and I am very passionate and dedicated to my work.
      </p>
